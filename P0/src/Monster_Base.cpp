...
try {
	...
	string Animations_Center_Filename = Data_Root_Directory + XML_Manager::Get_Option_String(Description_Filename, "Animation_Center_Filename");

	//Set animations
	Initialize_Animation_Center(Data_Root_Directory, Animations_Center_Filename, Attack_Animation, Death_Animation, Run_Animation, Walk_Animation, Hit_Animation, Stop_Animation, Pause_Animation);
...
void Monster_Base::Initialize_Animation_Center( const string &Data_Root_Directory, const string &Animation_Center_Filename, 
		Character_Animation* &Attack_Animation, Character_Animation* &Death_Animation, Character_Animation* &Run_Animation, Character_Animation* &Walk_Animation,
		Character_Animation* &Hit_Animation, Character_Animation* &Stop_Animation, Character_Animation* &Pause_Animation
		)
{
try {
///to be able to free at any time
	Stop_Animation = NULL;
	Walk_Animation = NULL;
	Run_Animation = NULL;
...
//animations that can be null
	...
	throw std::logic_error( "From Monster_Base::Initialize_Animation_Center(), " + (string)exc.what() );
} catch (...) {
	//unkown error occured
	throw std::logic_error( "Unhandled Error in Monster_Base::Initialize_Animation_Center()" );
}
}
