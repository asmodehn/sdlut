...
public:
     ...
     */
    virtual void pushInput(SDLut::Event sdlut_event);
     ...
     */
    void pushInput(const SDLut::Keyboard::Sym& s, bool& pressed);
     ...
     */
    void pushInput(const SDLut::Mouse::Button& button, const unsigned int& x, const unsigned int& y, const bool& pressed);
...
protected:
     ...
     */
    int convertMouseButton(SDLut::Mouse::Button sdlut_button);
     ...
     * @see Key
     */
    int convertKeyCharacter(SDLut::Keyboard::Sym sdlut_sym, bool KeyIsUp);
