    ...
    namespace SDL
    {
        ...
        public:
            ...
            typedef enum
            {
                ...
                KKp0, KKp1, KKp2, KKp3, KKp4, KKp5, KKp6, KKp7, KKp8, KKp9,
                KDivide, KMultiply, KEnter,
                KUp = SDLK_UP,
                KDown = SDLK_DOWN,
                KRight = SDLK_RIGHT,
                KLeft = SDLK_LEFT,
                KInsert, KHome, KEnd, KPageup, KPagedown, KF1, KF2, KF3, KF4, KF5, KF6, KF7, KF8, KF9, KF10, KF11, KF12, KF13, KF14, KF15,
                KNumlock, KCapslock, KScrollock, KRShift, KLshift, KLctrl, KRctrl, KRalt, KLalt, KRmeta, KLmeta, KRsuper, KLsuper, KMode, KCompose, KHelp, KPrintscreen, KSysreq, KBreak, KMenu, KPower, KEuro, KUndo
            }
            Key;
